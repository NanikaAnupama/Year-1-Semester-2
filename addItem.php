...
if(isset($_POST['Bsubmit'])){
    ...
    $sql = "insert into item(Name,startPrice,SID,Description,startDate,endDate,photo)
    values('$name','$price','$sellerId','$description','$startDate','$endDate','$file')";
...
<body>
    ...
    <section id="form-style">
        <form method = "post" enctype="multipart/form-data">
            ...
            <center><h2 style="padding-bottom:8px;">Add Item</h2></center>
