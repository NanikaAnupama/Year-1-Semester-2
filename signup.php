...
if(isset($_POST['Ssubmit'])){
    ...
    $sql = "insert into seller(Username,Address,Email,Password)
    values('$name','$address','$email','$password')";
...
<body>
    ...
    <section id="form-style">
        <form method = "post" onSubmit="return checkPassword()">
            ...
            <input type="checkbox" name="agree" id = "checkBox" onclick = "enableButton()">I accpect privacy policy<br>

             <input class="submit" type="submit" name="Bsubmit" id = "sbtn1" value="Register As a Buyer" disabled>
             <input class="submit" type="submit" name="Ssubmit" id = "sbtn2" value="Register As a Seller" disabled>
