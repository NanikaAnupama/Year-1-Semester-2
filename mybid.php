...
<body>
    ...
    <ul id="bar">
        ...
        <li><a style="color:#088178" class="bar12" href="mybid.php">My Bids</a></li>
  ...
  <tbody>
    ...
    $sql = "select i.Name,b.amount,b.BID,b.IID from bid b,item i where i.IID = b.IID AND b.BID = $buyerId";
